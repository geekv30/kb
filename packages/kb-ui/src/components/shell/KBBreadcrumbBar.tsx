        ...
        <div className="flex items-center gap-2 ml-auto pl-4 shrink-0">
          ...
          */}
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="inline-flex size-8 items-center justify-center rounded-[6px] text-[#64748b] hover:bg-[#f8fafc] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#cbd5e1]"
          >
            <RiCloseLine size={16} />
          </button>
        </div>
